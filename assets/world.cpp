...
Scene* DinoWorld::buildScene(){
    ...
    _light->setPos(glm::vec3(4.0, 10.0, 1.0));
    _light->setColor(glm::vec3(1.0, 0.0, 0.0));
    
    Shader* shader = Shader::fromFiles( "shaders/vertexshader_material.glsl", "shaders/fragment_material.glsl");            
    _light->bind(shader);
    Scene* main_scene = Scene::import("res/Dinosaure/Environement/Sol+Eau/volcano_lowpoly.dae", shader, _light);
    
    Scene* veg = Scene::import("res/Dinosaure/Environement/Végétation/végétation.dae", shader, _light);
    ...
    Scene* diplo_scene = Scene::import("res/Dinosaure/diplodocus/diplo.dae", shader, _light);
    ...
    Scene* boat_scene = Scene::import("res/Dinosaure/Boat/boat.dae", shader, _light);
    Scene* arm_scene = Scene::import("res/arm/brasmécanique.dae", shader, _light);
